...
def processImage(img_input):
    if isinstance(img_input, str):
        # Xử lý khi input là đường dẫn string
        ...
        # Xử lý khi input là đối tượng Image
        return img_input  # hoặc xử lý thêm nếu cần
...
def predict(image, model):
    ...
    #     im = image  # Nếu là đối tượng PIL.Image, trực tiếp sử dụng ảnh
    # else:
    #     # Nếu không phải đối tượng PIL, sử dụng cách mở tệp như trước
    #     im = Image.open(image)
    # img = transform(im).unsqueeze(0)
